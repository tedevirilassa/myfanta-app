...
async function main() {
  ...
  const team = await prisma.fantaTeam.findFirst({ where: { nome: "Meteora FC" } });
  if (!team) { console.error("FantaTeam Meteora FC non trovato."); process.exit(1); }
