...
async function main() {
  ...
  const team = await prisma.fantaTeam.findFirst({ where: { nome: "Giannik" } });
  if (!team) { console.error("FantaTeam Giannik non trovato."); process.exit(1); }
